...
<body>
  ...
  <div class="container">
    <h1 class="text-center fs-1"><b>Tadika Mesra Junior High School</b></h1><br />
    ...
    <div id="carouselExampleIndicators" class="carousel slide">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="FOTO/1.jpg" class="d-block w-100" alt="0">
        </div>
        <div class="carousel-item">
          <img src="FOTO/2.jpg" class="d-block w-100" alt="1">
        </div>
        <div class="carousel-item">
          <img src="FOTO/3.jpg" class="d-block w-100" alt="2">
        </div>
      </div>
